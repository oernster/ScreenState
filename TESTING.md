...
| The taskbar buttons are not left lit (FR-073) | Sign in and look at the taskbars: no button of a restored application should be lit as though it wanted attention. The log says how many buttons were settled and how many were drawing attention. A window no profile names should keep whatever state it had. |
